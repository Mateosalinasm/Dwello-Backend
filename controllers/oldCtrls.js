...
// const propertiesController = require('./propertiesCtrls.js')
// const db = require('../server.js')

// // const Property = require('../models/properties.js')

// //Index Route
// // router.get('/', propertiesController.getProperties(req, res))
// router.get('/jobs', propertiesController.getProperties, (req, res) => {
//     console.log('Hit the /properties route');
//     propertiesController.getProperties(req, res);
// });
// //Create Route
