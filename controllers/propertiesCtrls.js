...
const seedProperty = async (req, res) => {
    const properties = [
        ...
        },
        {
            ...
            description:
                "Jungle Shed is a unique property immersed in the breathtaking Atlantic Forest near Paraty. With a private waterfall and natural swimming pool, the house offers comfort and tranquility. It accommodates up to six people and features amenities like a fully equipped kitchen, yoga mats, and a 42' TV.",
            options: "2 bed | 1 bath",
            imageSrc:
        ...
        },
        {
            ...
            propertyImages: [
                ...
                "/images/Placencia Village/main private beach.png",
